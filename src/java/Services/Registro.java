 ...
 * @author Ale
 */
@WebService(serviceName = "PRegistroService", portName = "PRegistroPort", endpointInterface = "servicios.PRegistro", targetNamespace = "http://Servicios/", wsdlLocation = "http://localhost:1234/registro?wsdl")
