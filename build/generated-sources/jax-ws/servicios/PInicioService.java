 ...
 * 
 */
@WebServiceClient(name = "PInicioService", targetNamespace = "http://Servicios/", wsdlLocation = "http://localhost:1234/inicio?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1234/inicio?wsdl");
